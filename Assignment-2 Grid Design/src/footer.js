    ...
    <>
      <div class="footer">
        ...
        <ul class="footer_list">
          ...
          <li>
            <a href="">Become a Learning-Enable</a>
          </li>
          <li>
        ...
        <ul class="footer_list">
          ...
          <li>
            <p>
              ...
              McDonalds, ITPL Main Rd, Brookefield, <br />
          ...
          <li>
            ...
            <a href="#">
              <i class="fa-brands fa-linkedin-in" title="LinkdIn"></i>
            </a>
          </li>
          <li>
            <p>©2022</p> <p> zekeLabs Technologies Private Limited</p>
          </li>
        </ul>
      </div>
    </>
